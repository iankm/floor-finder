...
export const resourceList: Record<string, string>[] = [
  {
    name: 'Food Rarity',
    description: 'Food attributes and rarities sheet by @AustinGreen',
  ...
  {
    name: 'Food subgraph',
    description: 'Food bag, owner, and transfer subgraph by @shahruz',
  ...
  },
  {
    ...
    description: 'Food bag and item rarity explorer by @scotato',
  ...
  {
    name: 'FoodComponents.sol',
    description: 'Utility contract to easily interact with Food properties',
...
export const guildsList: Record<string, string>[] = [
  ...
  {
    name: 'Divine Lodge',
    description: 'For owners of Divine Food',
    url: 'https://tinyurl.com/divinelodge',
  },
  {
    name: 'Ancient Adventurers',
    description: 'For owners of Ancient Food',
...
export const derivativesList: Record<string, string>[] = [
  ...
  },
  {
    ...
    url: 'https://twitter.com/HolyWarFoods/status/1432984936747716609',
  },
  {
    name: 'Abodes',
    description: 'Randomized adventurer dwellings',
    url: 'https://twitter.com/FoodAbodes/status/1433031932904935439?s=20',
  },
  {
    name: 'Loot Army',
  ...
  },
  {
    ...
    url: 'https://twitter.com/HolyWarFoods/status/1433293231840653312',
  },
  {
    name: 'Treasure',
  ...
  {
    name: 'Food Avatars',
    description: 'The Avatars on chain for Food community',
